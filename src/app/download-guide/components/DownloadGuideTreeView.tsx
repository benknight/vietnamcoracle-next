...
export default function DownloadGuideTreeView({
  ...
  return (
    <div className="overflow-x-auto">
      <SimpleTreeView
        className="bg-black/5 dark:bg-white/5 rounded py-2 from-black/0 to-black/0 bg-[length:100%_4rem] bg-[repeating-linear-gradient(transparent,transparent_2rem,theme(colors.black/5%)_2rem,theme(colors.black/5%)_4rem)] dark:bg-[repeating-linear-gradient(transparent,transparent_2rem,theme(colors.white/5%)_2rem,theme(colors.white/5%)_4rem)] whitespace-nowrap min-w-[480px]"
