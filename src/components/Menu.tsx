      ...
      {({ open }) => (
        <>
          <Popover.Button
            className={cx(
              className,
              'flex items-center justify-center h-11 min-w-[2.5rem] uppercase text-xs rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 active:bg-gray-300 dark:active:bg-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary',
            )}
            id="menu-button">
            {children}
          </Popover.Button>
