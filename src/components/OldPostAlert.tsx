...
export default function OldPostAlert({ monthsOld = 0 }) {
  return (
    <div className="flex items-center py-4 px-2 mb-4 mt-3 rounded bg-yellow-100 bg-opacity-50 dark:bg-yellow-900  dark:bg-opacity-25 border border-yellow-100 dark:border-yellow-900">
