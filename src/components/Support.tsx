    ...
    <Block>
      ...
      <div className="max-w-xs mx-auto text-sm tracking-wider">
        <Link href="/donations-page">
          <a
            className={`${btnClassName} border-white dark:border-purple-400 dark:border-opacity-50 bg-purple-400 hover:bg-opacity-100 dark:hover:bg-opacity-75 text-white h-12`}>
